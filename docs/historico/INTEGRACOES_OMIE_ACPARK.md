> **DOCUMENTO HISTORICO — NAO USE COMO REFERENCIA.**
>
> Descreve a arquitetura de integracao anterior, substituida em 18/08/2026. Boa parte do que
> esta aqui nunca chegou a existir em codigo (locais, saldos, movimentos, reconciliacao,
> webhooks, metricas e circuit breaker estavam documentados mas nao implementados), e os
> nomes de job/escopo mudaram. A referencia atual e [docs/INTEGRACOES.md](../INTEGRACOES.md).
